...
import kr.co.nbw.composesearchapp.core.ui.model.AsyncImageState
import kr.co.nbw.composesearchapp.feature.favorite.R
...
fun FavoriteBookItem(
    ...
    val asyncImageState = remember { mutableStateOf(AsyncImageState.Loading) }
    Box(
        modifier = Modifier
            .aspectRatio(1f)
            .clickable {
        ...
        Box(
            ...
            AsyncImage(
                ...
                onState = { imageLoadState ->
                    when(imageLoadState) {
                        is AsyncImagePainter.State.Loading -> { asyncImageState.value = AsyncImageState.Loading }
